...
export class A2Planner {
  ...
  public async createInitialPlan(userRequest: string): Promise<InitialPlanOutput> {
    const prompt = [
      ...
      'Rules:',
      '- Include a dedicated polish/UX task near the end that covers visual consistency, interaction feedback (hover/active/loading/error/empty states), and removing anything that feels auto-generated (AI slop: emoji-stuffed headings, lorem ipsum, generic gradient styling, placeholder copy).',
      '- Every requirement for user-facing work must have at least one verification criterion about design quality and user experience, not just functionality.',
